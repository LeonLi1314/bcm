...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static Date getCurrentDate() {
		Date date = DateUtils.parseDate(DateUtils.formatDate(new Date()));
		return date;
	}
	...
	public static String addHour(String strDate, int hours) {
		...
		return DateUtils.formatDate(cal.getTime(), "yyyy-MM-dd HH:mm:ss");
	}
	...
	public static Map<String, List<String>> getAllWeekdays(Date indate,
			Date outdate) {
	...
	public static Object[] getOneWeekDays(Date indate, Date outdate, Date date) {
		...
		for (Iterator<Entry<String, List<String>>> it = resultMap.entrySet()
				.iterator(); it.hasNext();) {
	...
	private static void compareDate(String strdate1, String strdate2,
	...
	public static void main(String[] args) {
		...
		System.out.println(DateUtils.addHour(date, 24));
		String s= DateUtils.addHour(date, 24);
		long a =( DateUtils.parseDate(s).getTime()- DateUtils.parseDate(date).getTime())/1000/60/60;
		System.out.println(a);
		System.out.println(DateUtils.getHour(DateUtils.parseDate(s)));
	}
