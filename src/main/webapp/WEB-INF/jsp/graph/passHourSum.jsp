...
<body>
	...
	<script src="../highcharts/doubleLineChart.js"></script>
	<script>
		...
		$(function() {
			...
			function btnQuery_onClick() {
				$.ajax({
					url : WEB_ROOT + "/graph/getPassHourSum.do",
					async : false,
			...
			function btnQuerySuccess(rst) {
				...
				for (var i = 0; i < rst.length; i++) {
					...
					arrFirstValue.push(Math.floor(json.firstValue));
					arrSecondValue.push(parseFloat(json.secondValue));
				}
				lineChart(arrName, arrFirstValue, arrSecondValue);
			}
		});
	</script>
</body>
