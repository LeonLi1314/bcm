...
<c:if test="${LANG != 'zh_CN'  }">
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/en-msg.js"></script>
</c:if>
<c:if test="${LANG == 'zh_CN'  }">
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/zh-msg.js"></script>
</c:if>
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/apusic/om-apusic.css" />
<script type="text/javascript"
